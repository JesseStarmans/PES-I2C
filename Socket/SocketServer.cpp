...
/*std::string SocketServer::receiveData() {
    ...
    return "";  // Of gooi een uitzondering of handel de fout anders af
}*/
...
/*void SocketServer::processRFIDTag(const std::string& tagID) {
    RFIDData newTag(tagID);  // Maak een nieuw RFIDData object
    rfidTags.push_back(newTag);  // Voeg het toe aan de vector
    std::cout << "Nieuwe RFID tag opgeslagen: " << tagID << std::endl;
}
*/
